...
def minesweeper(n, k):  # Function to create a minesweeper board
    arr = [  # [0][1][2][3][4]*5
    ...
    for num in range(k):
        ...
        #                           0    1    2    3    4
        if x >= 1 and x <= 3:  # I this case exists    0.['0']['?']['?']['?']['0']
            arr[y][x + 1] += 1  # center right          0.['0']['0']['X']['-']['0']
            arr[y][x - 1] += 1  # center left           0.['0']['-']['X']['0']['0']
